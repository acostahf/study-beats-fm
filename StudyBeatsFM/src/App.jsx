...
function App() {
	...
	const FATunes = () => {
		setVideo(
			"//www.youtube.com/embed/N521f315E-c?autoplay=1&mute=1&start=1"
		);
		setStationName("FA Tunes");
		setYoutubeChannal("https://www.youtube.com/@lofieveryday364/featured");
		setLivestream("https://www.youtube.com/watch?v=N521f315E-c");
		playLiveStream(true);
		setPauseScreen("unpauseScreen");
		setPlayPause(pauseImg);
		setBtnClass("PlayPause2");
	...
	const HFiveGOneFunc = () => {
		setVideo(
			"//www.youtube.com/embed/lniKA4QHuxg?autoplay=1&mute=1&start=1"
		);
	...
	const Spinnin = () => {
		setVideo(
			"//www.youtube.com/embed/Oaq9uRxsJhQ?autoplay=1&mute=1&start=0"
		);
	...
	const animeVibe = (e) => {
		setVideo(
			"//www.youtube.com/embed/5B7Rsw0L2r8?autoplay=1&mute=1&start=0"
		);
				...
				<div className="socialsContainer2">
					<div className="socials">
						<motion.div
							...
							whileTap={{ scale: 0.9 }}
							onClick={() => {
								window.open("https://github.com/acostahf/study-beats-fm");
							}}
							className="link"
						>
